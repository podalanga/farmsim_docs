...
| `gains` | - | - | Controller | Kp, Kd, Kv gains (3-element list) for position control |
| `equation` | - | - | Controller | Actuation control law (e.g., `position`, `position_muscle`, `ekeberg_muscle`, `passive`) |
